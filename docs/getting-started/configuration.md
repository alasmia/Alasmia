...
| `ALASMIA_MODEL` | LLM model to use | `your_preferred_model` |
| `any OpenAI-compatible API_API_KEY` | any OpenAI-compatible API API key | `your_api_key` |

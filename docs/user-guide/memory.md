...
Alasmia: You're Doctor Kaif from Delhi. You run an n8n automation server at n8n.doctorkaif.dpdns.org. You're building an AI companion called Alasmia. You prefer Hinglish communication...
```

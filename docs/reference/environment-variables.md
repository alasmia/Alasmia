...
```bash
ALASMIA_MODEL=your_preferred_model
```

**Supported models:**
- `your_preferred_model` (default, recommended)
- `openai/gpt-4`
...
### `any OpenAI-compatible API_API_KEY`
any OpenAI-compatible API API key for any OpenAI-compatible API models.

```bash
any OpenAI-compatible API_API_KEY=your_any OpenAI-compatible API_key_here
```
...
ALASMIA_MODEL=your_preferred_model
any OpenAI-compatible API_API_KEY=your_key
